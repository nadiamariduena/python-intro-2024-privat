...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        required=True, nargs='+', #   nargs='+', you can provide one or more arguments separated by space when running the script. For example, python script.py --option value1 value2 value3.
