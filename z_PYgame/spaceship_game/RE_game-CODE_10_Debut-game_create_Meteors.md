...
>  This creates a new vector for the meteor's direction. The X component is a random value generated by uniform(-0.5, 0.5), `which gives a slight left or right movement`.
